...
##PCA plot, scree plot and summary
The Principal Component Analysis (PCA) plot shows the first two principal components which explain the variability in the data using the regularized log count data.  The scree plot shows the percentage contribution of each principal component (PC) to this variability. The PC summary shows the percentage contribution (bars in scree plot) and cumulative total (points in scree plot) for each PC.
