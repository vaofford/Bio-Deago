...
### PC scree plot and summary
The principal components (PC) scree plot shows the percentage contribution of each PC. The PC summary shows the percentage contribution (bars in scree plot) and cumulative total (points in scree plot) for each PC.
